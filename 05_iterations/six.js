...
// console.log(values); // For-each loop doesn't return anything(any value) just returns undefined. 
...
const books = [
  ...
  let userBooks = books.filter( (bk) => bk.genre === 'History') // When you are declaring it in a single line without using curly braces there's no need of return keyword. 
